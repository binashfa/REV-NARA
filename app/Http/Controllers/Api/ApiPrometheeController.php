    ...
    public function promethee(Request $request)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'hasilKepribadian' => $hasilKepribadian,

                'nilaiAkademikJurusan' => $nilaiAkademikJurusan,
                'nilaiPerMapel' => $nilaiPerMapel,
                'akademikJurusan' => $akademikJurusan,

                'rekomendasiJurusan' => $rekomendasiJurusan,

                'mapelTerbaik' => $mapelTerbaik,
                'nilaiMapelTerbaik' => $nilaiMapelTerbaik
            ]
        ]);
    }
