...
<body class="bg-gradient-to-b from-white via-[#fdfafa] to-[#faf6f6] min-h-screen font-sans antialiased overflow-x-hidden">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 pt-6 md:pt-10 pb-10">
        ...
        <div class="mt-8 bg-white rounded-[24px] md:rounded-[32px] border shadow-sm overflow-hidden">

            <div class="bg-gradient-to-r from-[#839958] to-[#105666]
                px-5 md:px-8 py-5 md:py-6">

                <h2 class="text-lg md:text-2xl font-black text-white flex items-center gap-3">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    @foreach($hasilPromethee as $jurusan => $siswas)

                    <div class="border rounded-2xl overflow-hidden">

                        <div class="bg-[#105666] text-white px-4 py-3">
                        ...
                        <div class="p-4 max-h-64 overflow-y-auto">
                            ...
                            <div class="flex items-center gap-2 py-2 border-b last:border-b-0">
                                ...
                                <div class="w-8 h-8 rounded-full bg-[#F7F4D5] flex items-center justify-center text-[#105666]">
