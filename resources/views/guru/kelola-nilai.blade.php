...
<main class="max-w-7xl mx-auto px-4 md:px-6 pt-4 md:pt-8 pb-16">
    ...
    <section class="bg-white rounded-[24px] md:rounded-[32px] shadow-sm border p-4 sm:p-6 md:p-8">
        ...
        <form method="GET" class="mb-6 md:mb-8">
            <select
                name="mapel_id"
        ...
        <div class="flex flex-col md:flex-row flex-wrap gap-3 mb-6 md:mb-8">

            <a href="/guru/template-nilai?mapel_id={{ $mapelId }}"
               class="px-5 py-3 rounded-xl bg-[#839958] text-white font-semibold text-center text-sm md:text-base
                      hover:bg-[#6f874a] transition shadow-sm w-full md:w-auto">
            ...
            <form method="POST" action="/guru/import-nilai" enctype="multipart/form-data"
                ...
                <input type="file" name="file" required
                       class="border border-gray-200 rounded-xl px-3 py-2 bg-white text-sm w-full sm:w-auto">

                <button type="submit"
                        class="px-5 py-3 rounded-xl bg-[#105666] text-white font-semibold text-sm md:text-base
                               hover:bg-[#0d4b59] transition shadow-sm w-full sm:w-auto text-center">
