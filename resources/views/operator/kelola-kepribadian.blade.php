...
<body class="bg-gradient-to-b from-white via-[#fdfafa] to-[#faf6f6] min-h-screen font-sans antialiased overflow-x-hidden">
    ...
    <main class="ml-0 lg:ml-[270px] min-h-screen px-4 md:px-6 pt-4 lg:pt-10 pb-10 transition-all duration-300">
        ...
        @if(session('success'))
        <div class="mb-6 bg-[#839958]/20 border border-[#839958]/40 text-[#5f713f] px-5 py-4 rounded-2xl text-sm md:text-base">
            {{ session('success') }}
        </div>
        @endif
                    ...
                    <table class="w-full text-sm min-w-max whitespace-nowrap">
                        ...
                        <thead>
                            <tr class="text-left text-gray-400 border-b-2 border-gray-100 uppercase text-[10px] md:text-xs">
                                <th class="py-4 pl-2 pr-4 text-center font-bold">No</th>
                                <th class="py-4 px-4 font-bold">Nama</th>
                                <th class="py-4 px-4 text-center font-bold">NISN</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-50 hover:bg-[#F7F4D5]/30 transition-all text-xs md:text-sm">
                                ...
                                <td class="py-3 md:py-4 px-4 text-center text-gray-600 align-middle">
                                    {{ $siswa->nisn }}
                                </td>
                                ...
                                <td class="py-3 md:py-4 px-4 text-center align-middle">

                                    @if($siswa->hasilKepribadian)

                                    <span class="inline-block bg-[#105666]/10 text-[#105666] px-3 md:px-4 py-1 md:py-1.5 rounded-full text-[10px] md:text-xs font-semibold">
                                        {{ $siswa->hasilKepribadian->hasil }}
                                    </span>

                                    @else

                                    <span class="text-gray-400 italic text-[10px] md:text-xs">
                                        Belum Ada
                                    </span>
