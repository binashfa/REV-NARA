...
<head>
    ...
    <style>
        ...
        @keyframes imageIn {
            0% {
                opacity: 0;
                transform: translateX(-35px) translateY(20px) scale(.9);
            }
        ...
        .image-animation {
            animation: imageIn .9s ease-out forwards, float 4s ease-in-out infinite 1s;
        }

        .form-animation {
            animation: formIn .9s ease-out forwards;
        }
                ...
                <form method="POST" action="/reset-password/{{ $user->id }}">
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            class="w-full h-[44px] rounded-full bg-[#F7F4D5]/10 px-5 text-white border border-white/20">
                    ...
                    <button
                        type="submit"
                        class="w-full h-[46px] rounded-full bg-[#D3968C] font-bold text-white hover:bg-[#c48479]">
